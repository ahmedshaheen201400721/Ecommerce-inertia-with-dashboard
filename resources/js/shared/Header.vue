  ...
  <nav class="flex justify-between bg-gray-100 border-b">
    <div class="px-12 py-8 flex w-full items-center">
      ...
      <div class="hidden xl:flex max-w-xs py-3 pl-8 pr-2 bg-white rounded-lg">
        <svg class="w-8 h-10 mt-4 mr-2" width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <select class="pl-6 pr-6 border-0 border-l border-gray-100 focus:border-gray-100 focus:ring-transparent focus:outline-none cursor-pointer"  id="">
      ...
      <div class="relative w-full md:w-1/2 px-4 mb-12 lg:mb-0">
        ...
        <div class="absolute bottom-1/2 -mb-24 lg:right-6 inline-block bg-white rounded-lg">
          <div class="flex p-3">
            ...
            <div class="w-auto">
              <img class="h-full lg:h-36 rounded-xl object-cover" src="https://cdn.vox-cdn.com/thumbor/3o5bkD-T3oQ3EIfXotA4k9P97TY=/1400x1400/filters:format(png)/cdn.vox-cdn.com/uploads/chorus_asset/file/22443013/5.png" alt="">
            </div>
          </div>
        </div>
        <img class="mx-auto h-96 lg:h-auto" src="https://previews.123rf.com/images/ultrahd/ultrahd1802/ultrahd180200050/96411170-tall-water-bottle-stlye-on-blue-backgound.jpg" alt="">
      </div>
    </div>
    <div class="w-full lg:w-5/6 xl:absolute left-0 bottom-0 right-0 bg-white py-12 px-8 lg:ml-auto">
      <div class="flex flex-wrap items-center justify-center -mx-2 -mb-12">
        <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
          <img class="mx-auto h-6" src="https://www.pngkey.com/png/detail/309-3099749_exxon-logo-exxon-mobil-corporation.png" alt="">
        </div>
        <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
          <img class="mx-auto h-6" src="https://i.pinimg.com/originals/69/16/88/691688bdbb9d94da1873bc657a167288.png" alt="">
        </div>
        <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
          <img class="mx-auto h-6" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Apple_logo_grey.svg/647px-Apple_logo_grey.svg.png" alt="">
        </div>
        <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
          <img class="mx-auto h-6" src="https://1000logos.net/wp-content/uploads/2017/06/gray-samsung-logo.jpg" alt="">
        </div>
        <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
          <img class="mx-auto h-6" src="https://p.kindpng.com/picc/s/613-6138213_aol-aol-logo-white-hd-png-download.png" alt="">
        </div>
        <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
          <img class="mx-auto h-6" src="https://xwiki.com/en/download/company/logos/lenovo-gray.png" alt="">
        </div>
      </div>
    </div>
  </div>
